...
namespace muni {
	CellMoveEscape::CellMoveEscape(EscapeConditionFunction escape_condition, std::shared_ptr<CellAction> action_when_not_escape) : escape_condition_(escape_condition), action_when_not_escape_(action_when_not_escape) {
	}
	
	void CellMoveEscape::send_frame(id<MNCell> cell, Environment &environment) {
